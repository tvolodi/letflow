defmodule Letflow.Repository.ArtifactKind do
  ...
  all declare their own `Ecto.Enum` field against, so the seven-atom value
  ...
  @type t :: :definition | :form | :schema | :service_catalog | :script | :module | :scenario

  @doc "The shared seven-atom `artifact_kind` value list."
  @spec values() :: [t()]
